    ...
    <>
      <div className={`cartmini__area tp-all-font-roboto ${cartMiniOpen ? 'cartmini-opened' : ''}`}>
        <div className="cartmini__wrapper d-flex justify-content-between flex-column">
          <div className="cartmini__top-wrapper flex-grow">
            ...
            {cart_products.length === 0 && (
              <div
                className="cartmini__empty text-center d-flex flex-column justify-content-center align-items-center"
                style={{
                  flex: 1,
                  minHeight: '50vh',
                  marginTop: '-40px',
              ...
              >
                <Image src={empty_cart_img} alt="empty-cart-img" style={{ width: '170px', height: 'auto' }} />
                <p className="mt-1">Your Cart is empty</p>
                <Link href="/shop" className="tp-btn mt-2">
                  Go To Shop
                </Link>
              </div>
            )}
